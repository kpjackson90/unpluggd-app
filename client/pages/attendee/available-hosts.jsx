...
const AvailableHosts = () => {
  const [hosts, setHosts] = useState([
    { img: "host-1", name: "Jim Beglin", online: false, icons: ["icon-art", "icon-music", "icon-food"], events: 32, followers: 368, following: false },
    { img: "host-2", name: "Jim Beglin", online: true, icons: ["icon-art", "icon-music", "icon-food"], events: 32, followers: 368, following: false },
    { img: "host-3", name: "Jim Beglin", online: true, icons: ["icon-art", "icon-music", "icon-food"], events: 32, followers: 368, following: true },
    { img: "host-4", name: "Jim Beglin", online: false, icons: ["icon-art", "icon-music", "icon-food"], events: 32, followers: 368, following: false },
    ...
    { img: "host-7", name: "Jim Beglin", online: false, icons: ["icon-art", "icon-music", "icon-food"], events: 32, followers: 368, following: false },
    ...
    { img: "host-3", name: "Jim Beglin", online: true, icons: ["icon-art", "icon-music", "icon-food"], events: 32, followers: 368, following: false },
    { img: "host-4", name: "Jim Beglin", online: false, icons: ["icon-art", "icon-music", "icon-food"], events: 32, followers: 368, following: false },
  ]);
            ...
            {hosts.map((h, i) => {
              ...
              return (
                <div key={i}>
                  ...
                  <div>
                  {!following ? (
                      <p className="f-14 text-teal fw-400 mb-0">Follow Host</p>
                    ) : (
